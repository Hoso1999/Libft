...
struct		list
{
	...
	node_t		*end;
	int			size;
	void		(*push_back)(list_t *lst, void *data);
	void		(*push_front)(list_t *lst, void *data);
...
void				ft_list_push_back(list_t *lst, void *data);

void				ft_list_pop_front(list_t *lst);

void				ft_list_pop_back(list_t *lst);

void				ft_list_push_front(list_t *lst, void *data);
...
node_t				*ft_node_constructor(void *data);
...
list_t				ft_list_initalizer_array_constructor(int *arr, int size);
